...
public class MyPostFromTextFile {
	...
	public void user_hit_the_post_request_with_json_data(String username) throws IOException{
		...
		//Read data from file
		String data = ""; 
	    data = new String(Files.readAllBytes(Paths.get("C:\\Selenium\\B18CucuRestAssured1\\src\\test\\java\\com\\basic\\postUpdatedJsonSD\\user.json"))); 
	    ...
	    object.put("name", username+myTimeStamp); //timestamp user chya bajula takla .. repeate nako user mhanun for uniqueness
	    
	    String newJsonStr = object.toString(); // converted to string
